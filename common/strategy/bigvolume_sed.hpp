...
#ifndef BIGVOLUME_SED_HPP_
#define BIGVOLUME_SED_HPP_
...
class BigVolume_Sed:public StrategyBase
{

public:
	BigVolume_Sed();
	BigVolume_Sed(DataWrapper * datawrapper,const char* strategyname);
	void  Open();
	void  opentest();
