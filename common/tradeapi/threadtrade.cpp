...
void ThreadTrade::Run2(){

	EventEngine eventengine;
	Gatewaymanager gatewaymanager(&eventengine);
	CTAmanager ctamanager(&gatewaymanager,&eventengine);
...
void ThreadTrade::Run(){
	if(this->GetUserid()=="081759" || this->GetUserid()=="17300731"){

#ifdef DEBUG
		std::cout<<"   base account >>>>>"<<this->GetUserid()<<endl;
#endif
