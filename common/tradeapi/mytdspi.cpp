...
//		strcpy(userLoginField.BrokerID, "8888");
//			strcpy(userLoginField.UserID, "17300731");
//			strcpy(userLoginField.Password, "ar20180218");
//			strcpy(userLoginField.UserProductInfo,"ANYUNSYS10");
		Config config(this->GetStrategyName().c_str());
...
//		userLoginField.LoginRemark
//		userLoginField.MacAddress
//		userLoginField.ProtocolInfo
		printf("TradeBase::UserLogin   %s--->>>> \nBrokerID:%s \nUserID:%s  \nUserProductInfo:%s \n",
		...
		result_login=this->m_pUserApi->ReqUserLogin(&userLoginField, m_requestID++);
			...
			strcpy(userLoginField.BrokerID, "8888");
			strcpy(userLoginField.UserID, "11118888");
			strcpy(userLoginField.Password, "zlqh1234");
			strcpy(userLoginField.UserProductInfo,"ANYUNSYS10");
//			strcpy(userLoginField.)
...
//			userLoginField.ClientIPPort
//			userLoginField.OneTimePassword
//			userLoginField.Password

			printf("TradeBase::UserLogin   CalendarSpreadTrade_zlqh--->>>> \nBrokerID:%s \nUserID:%s  \nUserProductInfo:%s \n",userLoginField.BrokerID,
					userLoginField.UserID,userLoginField.UserProductInfo);
