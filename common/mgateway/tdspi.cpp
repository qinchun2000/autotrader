...
void CTPTD::SetBrokerID(const char* id)
{
	this->m_brokerID=id;
}

std::string CTPTD::GetBrokerID()
{
	return this->m_brokerID;
}

void CTPTD::SetUserID(const char* id)
{
	this->m_userID=id;
}

std::string CTPTD::GetUserID()
{
	return this->m_userID;
}

void CTPTD::SetProductInfo(const char* info)
{
	this->m_productifno=info;
}

std::string CTPTD::GetProductInfo()
{
	return this->m_productifno;
}
